...
# agent = DQNAgent(env, models, lr=0.001, gamma=0.9, epsilon_start=0.2, epsilon_end=0.01, epsilon_decay=0.99,
...
# agent = DQNAgent(env, models, lr=0.001, gamma=0.9, epsilon_start=0.5, epsilon_end=0.01, epsilon_decay=0.99,
